...
func (q {{$alias.DownSingular}}Query) UpsertG(o *{{$alias.UpSingular}}, {{if not .NoContext}}ctx context.Context, {{end -}} updateColumns, insertColumns boil.Columns) error {
...
func (q {{$alias.DownSingular}}Query) UpsertGP(o *{{$alias.UpSingular}}, {{if not .NoContext}}ctx context.Context, {{end -}} updateColumns, insertColumns boil.Columns) {
...
func (q {{$alias.DownSingular}}Query) UpsertP(o *{{$alias.UpSingular}}, {{if .NoContext}}exec boil.Executor{{else}}ctx context.Context, exec boil.ContextExecutor{{end}}, updateColumns, insertColumns boil.Columns) {
...
func (q {{$alias.DownSingular}}Query) Upsert(o *{{$alias.UpSingular}}, {{if .NoContext}}exec boil.Executor{{else}}ctx context.Context, exec boil.ContextExecutor{{end}}, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
