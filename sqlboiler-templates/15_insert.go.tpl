...
type {{$alias.UpSingular}}Inserter interface {
  Insert(o *{{$alias.UpSingular}}, {{if .NoContext}}exec boil.Executor{{else}}ctx context.Context, exec boil.ContextExecutor{{end}}, columns boil.Columns) error
{{if .AddGlobal -}}
  InsertG(o *{{$alias.UpSingular}}, {{if not .NoContext}}ctx context.Context, {{end -}} columns boil.Columns) error
{{end -}}
{{if .AddPanic -}}
  InsertP(o *{{$alias.UpSingular}}, {{if .NoContext}}exec boil.Executor{{else}}ctx context.Context, exec boil.ContextExecutor{{end}}, columns boil.Columns)
{{end -}}
{{if and .AddGlobal .AddPanic -}}
  InsertGP(o *{{$alias.UpSingular}}, {{if not .NoContext}}ctx context.Context, {{end -}} columns boil.Columns)
{{end -}}
}
