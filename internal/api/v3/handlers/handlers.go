...
import (
	...
	// Needed for swagger
	_ "github.tools.sap/cloudfoundry/cloudgontroller/internal/api/swagger"
	buildpacks "github.tools.sap/cloudfoundry/cloudgontroller/internal/api/v3/buildpacks"
