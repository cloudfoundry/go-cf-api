...
type (
	...
	// StackAnnotationHook is the signature for custom StackAnnotation hook methods
	StackAnnotationHook func(context.Context, boil.ContextExecutor, *StackAnnotation) error
...
var stackAnnotationBeforeInsertHooks []StackAnnotationHook
var stackAnnotationBeforeUpdateHooks []StackAnnotationHook
var stackAnnotationBeforeDeleteHooks []StackAnnotationHook
var stackAnnotationBeforeUpsertHooks []StackAnnotationHook

var stackAnnotationAfterInsertHooks []StackAnnotationHook
var stackAnnotationAfterSelectHooks []StackAnnotationHook
var stackAnnotationAfterUpdateHooks []StackAnnotationHook
var stackAnnotationAfterDeleteHooks []StackAnnotationHook
var stackAnnotationAfterUpsertHooks []StackAnnotationHook

// doBeforeInsertHooks executes all "before insert" hooks.
func (o *StackAnnotation) doBeforeInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackAnnotationBeforeInsertHooks {
...
func (o *StackAnnotation) doBeforeUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackAnnotationBeforeUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackAnnotation) doBeforeDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackAnnotationBeforeDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackAnnotation) doBeforeUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackAnnotationBeforeUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackAnnotation) doAfterInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackAnnotationAfterInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackAnnotation) doAfterSelectHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackAnnotationAfterSelectHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackAnnotation) doAfterUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackAnnotationAfterUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackAnnotation) doAfterDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackAnnotationAfterDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackAnnotation) doAfterUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackAnnotationAfterUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
// AddStackAnnotationHook registers your hook function for all future operations.
func AddStackAnnotationHook(hookPoint boil.HookPoint, stackAnnotationHook StackAnnotationHook) {
	switch hookPoint {
	case boil.BeforeInsertHook:
		stackAnnotationBeforeInsertHooks = append(stackAnnotationBeforeInsertHooks, stackAnnotationHook)
	case boil.BeforeUpdateHook:
		stackAnnotationBeforeUpdateHooks = append(stackAnnotationBeforeUpdateHooks, stackAnnotationHook)
	case boil.BeforeDeleteHook:
		stackAnnotationBeforeDeleteHooks = append(stackAnnotationBeforeDeleteHooks, stackAnnotationHook)
	case boil.BeforeUpsertHook:
		stackAnnotationBeforeUpsertHooks = append(stackAnnotationBeforeUpsertHooks, stackAnnotationHook)
	case boil.AfterInsertHook:
		stackAnnotationAfterInsertHooks = append(stackAnnotationAfterInsertHooks, stackAnnotationHook)
	case boil.AfterSelectHook:
		stackAnnotationAfterSelectHooks = append(stackAnnotationAfterSelectHooks, stackAnnotationHook)
	case boil.AfterUpdateHook:
		stackAnnotationAfterUpdateHooks = append(stackAnnotationAfterUpdateHooks, stackAnnotationHook)
	case boil.AfterDeleteHook:
		stackAnnotationAfterDeleteHooks = append(stackAnnotationAfterDeleteHooks, stackAnnotationHook)
	case boil.AfterUpsertHook:
		stackAnnotationAfterUpsertHooks = append(stackAnnotationAfterUpsertHooks, stackAnnotationHook)
	}
}
...
func (q stackAnnotationQuery) All(ctx context.Context, exec boil.ContextExecutor) (StackAnnotationSlice, error) {
	...
	if len(stackAnnotationAfterSelectHooks) != 0 {
		for _, obj := range o {
...
func (o *StackAnnotation) Resource(mods ...qm.QueryMod) stackQuery {
...
func (o *StackAnnotation) SetResource(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Stack) error {
	var err error
	if insert {
...
func (o *StackAnnotation) RemoveResource(ctx context.Context, exec boil.ContextExecutor, related *Stack) error {
	var err error
...
func FindStackAnnotation(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*StackAnnotation, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"stack_annotations\" where \"id\"=$1", sel,
	)
	...
	if err = stackAnnotationObj.doAfterSelectHooks(ctx, exec); err != nil {
		return stackAnnotationObj, err
	}
...
func (o *StackAnnotation) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO \"stack_annotations\" %sDEFAULT VALUES%s"
		}
...
func (o *StackAnnotation) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"stack_annotations\" SET %s WHERE %s",
			...
			strmangle.WhereClause("\"", "\"", len(wl)+1, stackAnnotationPrimaryKeyColumns),
		)
...
func (o StackAnnotationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
	...
	sql := fmt.Sprintf("UPDATE \"stack_annotations\" SET %s WHERE %s",
		...
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), len(colNames)+1, stackAnnotationPrimaryKeyColumns, len(o)))
...
func (o *StackAnnotation) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 {
			conflict = make([]string, len(stackAnnotationPrimaryKeyColumns))
			copy(conflict, stackAnnotationPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"stack_annotations\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert stack_annotations")
	}
...
func (o *StackAnnotation) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
	...
	sql := "DELETE FROM \"stack_annotations\" WHERE \"id\"=$1"
...
func (o StackAnnotationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}

	if len(stackAnnotationBeforeDeleteHooks) != 0 {
		for _, obj := range o {
	...
	sql := "DELETE FROM \"stack_annotations\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, stackAnnotationPrimaryKeyColumns, len(o))
	...
	if len(stackAnnotationAfterDeleteHooks) != 0 {
		for _, obj := range o {
...
func (o *StackAnnotation) Reload(ctx context.Context, exec boil.ContextExecutor) error {
...
func (o *StackAnnotationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	if o == nil || len(*o) == 0 {
		return nil
	}
...
func StackAnnotationExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"stack_annotations\" where \"id\"=$1 limit 1)"
