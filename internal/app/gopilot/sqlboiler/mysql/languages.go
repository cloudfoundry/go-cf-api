...
var LanguageWhere = struct {
	...
	ID:       whereHelperuint64{field: "`languages`.`id`"},
...
func FindLanguage(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Language, error) {
...
func LanguageExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
