...
type Jet struct {
	...
	PilotID uint64 `boil:"pilot_id" json:"pilot_id" toml:"pilot_id" yaml:"pilot_id"`
...
var JetWhere = struct {
	...
	PilotID whereHelperuint64
	Age     whereHelperint
	Name    whereHelperstring
	Color   whereHelperstring
}{
	ID:      whereHelperuint64{field: "`jets`.`id`"},
	PilotID: whereHelperuint64{field: "`jets`.`pilot_id`"},
...
func FindJet(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Jet, error) {
	jetObj := &Jet{}
...
func JetExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
