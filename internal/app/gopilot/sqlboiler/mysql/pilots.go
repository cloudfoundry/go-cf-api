...
var PilotWhere = struct {
	...
	ID:   whereHelperuint64{field: "`pilots`.`id`"},
...
func FindPilot(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Pilot, error) {
	pilotObj := &Pilot{}
...
func PilotExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
