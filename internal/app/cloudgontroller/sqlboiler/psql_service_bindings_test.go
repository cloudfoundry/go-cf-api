...
var (
	serviceBindingDBTypes = map[string]string{`ID`: `integer`, `GUID`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `Credentials`: `text`, `Salt`: `text`, `SyslogDrainURL`: `text`, `VolumeMounts`: `text`, `VolumeMountsSalt`: `text`, `AppGUID`: `text`, `ServiceInstanceGUID`: `text`, `Type`: `text`, `Name`: `character varying`, `EncryptionKeyLabel`: `character varying`, `EncryptionIterations`: `integer`}
	_                     = bytes.MinRead
)
