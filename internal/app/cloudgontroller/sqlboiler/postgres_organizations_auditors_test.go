...
var (
	organizationsAuditorDBTypes = map[string]string{`OrganizationID`: `integer`, `UserID`: `integer`, `OrganizationsAuditorsPK`: `integer`, `RoleGUID`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_                           = bytes.MinRead
)
