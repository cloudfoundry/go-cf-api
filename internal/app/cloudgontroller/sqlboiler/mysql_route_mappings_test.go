...
var (
	routeMappingDBTypes = map[string]string{`ID`: `int`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `AppPort`: `int`, `GUID`: `varchar`, `AppGUID`: `varchar`, `RouteGUID`: `varchar`, `ProcessType`: `varchar`, `Weight`: `int`}
	_                   = bytes.MinRead
)
...
func testRouteMappingsUpsert(t *testing.T) {
	...
	if len(mySQLRouteMappingUniqueColumns) == 0 {
