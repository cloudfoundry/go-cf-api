...
var (
	buildpackLifecycleBuildpackDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `AdminBuildpackName`: `varchar`, `EncryptedBuildpackURL`: `varchar`, `EncryptedBuildpackURLSalt`: `varchar`, `BuildpackLifecycleDataGUID`: `varchar`, `EncryptionKeyLabel`: `varchar`, `Version`: `varchar`, `BuildpackName`: `varchar`, `EncryptionIterations`: `int`}
	_                                  = bytes.MinRead
)
...
func testBuildpackLifecycleBuildpacksUpsert(t *testing.T) {
	...
	if len(mySQLBuildpackLifecycleBuildpackUniqueColumns) == 0 {
