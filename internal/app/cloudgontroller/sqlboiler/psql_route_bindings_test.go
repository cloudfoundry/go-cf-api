...
var (
	routeBindingDBTypes = map[string]string{`ID`: `integer`, `GUID`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `RouteID`: `integer`, `ServiceInstanceID`: `integer`, `RouteServiceURL`: `text`}
	_                   = bytes.MinRead
)
