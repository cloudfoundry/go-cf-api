...
type (
	...
	// StackLabelHook is the signature for custom StackLabel hook methods
	StackLabelHook func(context.Context, boil.ContextExecutor, *StackLabel) error
...
var stackLabelBeforeInsertHooks []StackLabelHook
var stackLabelBeforeUpdateHooks []StackLabelHook
var stackLabelBeforeDeleteHooks []StackLabelHook
var stackLabelBeforeUpsertHooks []StackLabelHook

var stackLabelAfterInsertHooks []StackLabelHook
var stackLabelAfterSelectHooks []StackLabelHook
var stackLabelAfterUpdateHooks []StackLabelHook
var stackLabelAfterDeleteHooks []StackLabelHook
var stackLabelAfterUpsertHooks []StackLabelHook

// doBeforeInsertHooks executes all "before insert" hooks.
func (o *StackLabel) doBeforeInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackLabelBeforeInsertHooks {
...
func (o *StackLabel) doBeforeUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackLabelBeforeUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackLabel) doBeforeDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackLabelBeforeDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackLabel) doBeforeUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackLabelBeforeUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackLabel) doAfterInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackLabelAfterInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackLabel) doAfterSelectHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackLabelAfterSelectHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackLabel) doAfterUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackLabelAfterUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackLabel) doAfterDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackLabelAfterDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *StackLabel) doAfterUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range stackLabelAfterUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
// AddStackLabelHook registers your hook function for all future operations.
func AddStackLabelHook(hookPoint boil.HookPoint, stackLabelHook StackLabelHook) {
	switch hookPoint {
	case boil.BeforeInsertHook:
		stackLabelBeforeInsertHooks = append(stackLabelBeforeInsertHooks, stackLabelHook)
	case boil.BeforeUpdateHook:
		stackLabelBeforeUpdateHooks = append(stackLabelBeforeUpdateHooks, stackLabelHook)
	case boil.BeforeDeleteHook:
		stackLabelBeforeDeleteHooks = append(stackLabelBeforeDeleteHooks, stackLabelHook)
	case boil.BeforeUpsertHook:
		stackLabelBeforeUpsertHooks = append(stackLabelBeforeUpsertHooks, stackLabelHook)
	case boil.AfterInsertHook:
		stackLabelAfterInsertHooks = append(stackLabelAfterInsertHooks, stackLabelHook)
	case boil.AfterSelectHook:
		stackLabelAfterSelectHooks = append(stackLabelAfterSelectHooks, stackLabelHook)
	case boil.AfterUpdateHook:
		stackLabelAfterUpdateHooks = append(stackLabelAfterUpdateHooks, stackLabelHook)
	case boil.AfterDeleteHook:
		stackLabelAfterDeleteHooks = append(stackLabelAfterDeleteHooks, stackLabelHook)
	case boil.AfterUpsertHook:
		stackLabelAfterUpsertHooks = append(stackLabelAfterUpsertHooks, stackLabelHook)
	}
}
...
func (q stackLabelQuery) All(ctx context.Context, exec boil.ContextExecutor) (StackLabelSlice, error) {
	...
	if len(stackLabelAfterSelectHooks) != 0 {
		for _, obj := range o {
...
func (o *StackLabel) Resource(mods ...qm.QueryMod) stackQuery {
...
func (o *StackLabel) SetResource(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Stack) error {
	var err error
	if insert {
	...
	updateQuery := fmt.Sprintf(
		...
		strmangle.WhereClause("`", "`", 0, stackLabelPrimaryKeyColumns),
	)
...
func (o *StackLabel) RemoveResource(ctx context.Context, exec boil.ContextExecutor, related *Stack) error {
	var err error
...
func FindStackLabel(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*StackLabel, error) {
	...
	query := fmt.Sprintf(
		"select %s from `stack_labels` where `id`=?", sel,
	)
	...
	if err = stackLabelObj.doAfterSelectHooks(ctx, exec); err != nil {
		return stackLabelObj, err
	}
...
func (o *StackLabel) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO `stack_labels` () VALUES ()%s%s"
		}

		var queryOutput, queryReturning string

		if len(cache.retMapping) != 0 {
			cache.retQuery = fmt.Sprintf("SELECT `%s` FROM `stack_labels` WHERE %s", strings.Join(returnColumns, "`,`"), strmangle.WhereClause("`", "`", 0, stackLabelPrimaryKeyColumns))
		}
	...
	o.ID = int(lastID)
	if lastID != 0 && len(cache.retMapping) == 1 && cache.retMapping[0] == stackLabelMapping["id"] {
		goto CacheNoHooks
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for stack_labels")
	}
...
func (o *StackLabel) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
...
func (o StackLabelSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
	...
	sql := fmt.Sprintf("UPDATE `stack_labels` SET %s WHERE %s",
		...
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, stackLabelPrimaryKeyColumns, len(o)))
...
var mySQLStackLabelUniqueColumns = []string{
	"id",
	"guid",
}
...
func (o *StackLabel) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	nzDefaults := queries.NonZeroDefaultSet(stackLabelColumnsWithDefault, o)
	nzUniques := queries.NonZeroDefaultSet(mySQLStackLabelUniqueColumns, o)
	...
	if !cached {
		...
		cache.query = buildUpsertQueryMySQL(dialect, "`stack_labels`", update, insert)
		cache.retQuery = fmt.Sprintf(
			"SELECT %s FROM `stack_labels` WHERE %s",
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for stack_labels")
	}
	...
	uniqueMap, err = queries.BindMapping(stackLabelType, stackLabelMapping, nzUniques)
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for stack_labels")
	}
...
func (o *StackLabel) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
	...
	sql := "DELETE FROM `stack_labels` WHERE `id`=?"
...
func (o StackLabelSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}

	if len(stackLabelBeforeDeleteHooks) != 0 {
		for _, obj := range o {
	...
	if len(stackLabelAfterDeleteHooks) != 0 {
		for _, obj := range o {
...
func (o *StackLabel) Reload(ctx context.Context, exec boil.ContextExecutor) error {
...
func (o *StackLabelSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	if o == nil || len(*o) == 0 {
		return nil
	}
...
func StackLabelExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `stack_labels` where `id`=? limit 1)"
