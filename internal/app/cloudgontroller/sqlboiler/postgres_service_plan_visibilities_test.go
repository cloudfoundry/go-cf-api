...
var (
	servicePlanVisibilityDBTypes = map[string]string{`ID`: `integer`, `GUID`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `ServicePlanID`: `integer`, `OrganizationID`: `integer`}
	_                            = bytes.MinRead
)
