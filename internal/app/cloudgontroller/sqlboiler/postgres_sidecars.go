...
type (
	...
	// SidecarHook is the signature for custom Sidecar hook methods
	SidecarHook func(context.Context, boil.ContextExecutor, *Sidecar) error
...
var sidecarBeforeInsertHooks []SidecarHook
var sidecarBeforeUpdateHooks []SidecarHook
var sidecarBeforeDeleteHooks []SidecarHook
var sidecarBeforeUpsertHooks []SidecarHook

var sidecarAfterInsertHooks []SidecarHook
var sidecarAfterSelectHooks []SidecarHook
var sidecarAfterUpdateHooks []SidecarHook
var sidecarAfterDeleteHooks []SidecarHook
var sidecarAfterUpsertHooks []SidecarHook

// doBeforeInsertHooks executes all "before insert" hooks.
func (o *Sidecar) doBeforeInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range sidecarBeforeInsertHooks {
...
func (o *Sidecar) doBeforeUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range sidecarBeforeUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *Sidecar) doBeforeDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range sidecarBeforeDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *Sidecar) doBeforeUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range sidecarBeforeUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *Sidecar) doAfterInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range sidecarAfterInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *Sidecar) doAfterSelectHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range sidecarAfterSelectHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *Sidecar) doAfterUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range sidecarAfterUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *Sidecar) doAfterDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range sidecarAfterDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *Sidecar) doAfterUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range sidecarAfterUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
// AddSidecarHook registers your hook function for all future operations.
func AddSidecarHook(hookPoint boil.HookPoint, sidecarHook SidecarHook) {
	switch hookPoint {
	case boil.BeforeInsertHook:
		sidecarBeforeInsertHooks = append(sidecarBeforeInsertHooks, sidecarHook)
	case boil.BeforeUpdateHook:
		sidecarBeforeUpdateHooks = append(sidecarBeforeUpdateHooks, sidecarHook)
	case boil.BeforeDeleteHook:
		sidecarBeforeDeleteHooks = append(sidecarBeforeDeleteHooks, sidecarHook)
	case boil.BeforeUpsertHook:
		sidecarBeforeUpsertHooks = append(sidecarBeforeUpsertHooks, sidecarHook)
	case boil.AfterInsertHook:
		sidecarAfterInsertHooks = append(sidecarAfterInsertHooks, sidecarHook)
	case boil.AfterSelectHook:
		sidecarAfterSelectHooks = append(sidecarAfterSelectHooks, sidecarHook)
	case boil.AfterUpdateHook:
		sidecarAfterUpdateHooks = append(sidecarAfterUpdateHooks, sidecarHook)
	case boil.AfterDeleteHook:
		sidecarAfterDeleteHooks = append(sidecarAfterDeleteHooks, sidecarHook)
	case boil.AfterUpsertHook:
		sidecarAfterUpsertHooks = append(sidecarAfterUpsertHooks, sidecarHook)
	}
}
...
func (o *Sidecar) App(mods ...qm.QueryMod) appQuery {
...
func (o *Sidecar) SidecarProcessTypes(mods ...qm.QueryMod) sidecarProcessTypeQuery {
...
func (o *Sidecar) SetApp(ctx context.Context, exec boil.ContextExecutor, insert bool, related *App) error {
	var err error
	if insert {
...
func (o *Sidecar) AddSidecarProcessTypes(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*SidecarProcessType) error {
	var err error
...
func FindSidecar(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Sidecar, error) {
	...
	if err = sidecarObj.doAfterSelectHooks(ctx, exec); err != nil {
		return sidecarObj, err
	}
...
func (o *Sidecar) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
...
func (o *Sidecar) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
...
func (o SidecarSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
...
func (o *Sidecar) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
...
func (o *Sidecar) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
...
func (o SidecarSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}

	if len(sidecarBeforeDeleteHooks) != 0 {
		for _, obj := range o {
	...
	if len(sidecarAfterDeleteHooks) != 0 {
		for _, obj := range o {
...
func (o *Sidecar) Reload(ctx context.Context, exec boil.ContextExecutor) error {
...
func (o *SidecarSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	if o == nil || len(*o) == 0 {
		return nil
	}
