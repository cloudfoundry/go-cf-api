...
var (
	serviceKeyOperationDBTypes = map[string]string{`ID`: `int`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `ServiceKeyID`: `int`, `State`: `varchar`, `Type`: `varchar`, `Description`: `varchar`, `BrokerProvidedOperation`: `varchar`}
	_                          = bytes.MinRead
)
...
func testServiceKeyOperationsUpsert(t *testing.T) {
	...
	if len(mySQLServiceKeyOperationUniqueColumns) == 0 {
