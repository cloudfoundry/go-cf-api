...
type (
	...
	// ServicePlanLabelHook is the signature for custom ServicePlanLabel hook methods
	ServicePlanLabelHook func(context.Context, boil.ContextExecutor, *ServicePlanLabel) error
...
var servicePlanLabelBeforeInsertHooks []ServicePlanLabelHook
var servicePlanLabelBeforeUpdateHooks []ServicePlanLabelHook
var servicePlanLabelBeforeDeleteHooks []ServicePlanLabelHook
var servicePlanLabelBeforeUpsertHooks []ServicePlanLabelHook

var servicePlanLabelAfterInsertHooks []ServicePlanLabelHook
var servicePlanLabelAfterSelectHooks []ServicePlanLabelHook
var servicePlanLabelAfterUpdateHooks []ServicePlanLabelHook
var servicePlanLabelAfterDeleteHooks []ServicePlanLabelHook
var servicePlanLabelAfterUpsertHooks []ServicePlanLabelHook

// doBeforeInsertHooks executes all "before insert" hooks.
func (o *ServicePlanLabel) doBeforeInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range servicePlanLabelBeforeInsertHooks {
...
func (o *ServicePlanLabel) doBeforeUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range servicePlanLabelBeforeUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *ServicePlanLabel) doBeforeDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range servicePlanLabelBeforeDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *ServicePlanLabel) doBeforeUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range servicePlanLabelBeforeUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *ServicePlanLabel) doAfterInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range servicePlanLabelAfterInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *ServicePlanLabel) doAfterSelectHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range servicePlanLabelAfterSelectHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *ServicePlanLabel) doAfterUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range servicePlanLabelAfterUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *ServicePlanLabel) doAfterDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range servicePlanLabelAfterDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *ServicePlanLabel) doAfterUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range servicePlanLabelAfterUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
// AddServicePlanLabelHook registers your hook function for all future operations.
func AddServicePlanLabelHook(hookPoint boil.HookPoint, servicePlanLabelHook ServicePlanLabelHook) {
	switch hookPoint {
	case boil.BeforeInsertHook:
		servicePlanLabelBeforeInsertHooks = append(servicePlanLabelBeforeInsertHooks, servicePlanLabelHook)
	case boil.BeforeUpdateHook:
		servicePlanLabelBeforeUpdateHooks = append(servicePlanLabelBeforeUpdateHooks, servicePlanLabelHook)
	case boil.BeforeDeleteHook:
		servicePlanLabelBeforeDeleteHooks = append(servicePlanLabelBeforeDeleteHooks, servicePlanLabelHook)
	case boil.BeforeUpsertHook:
		servicePlanLabelBeforeUpsertHooks = append(servicePlanLabelBeforeUpsertHooks, servicePlanLabelHook)
	case boil.AfterInsertHook:
		servicePlanLabelAfterInsertHooks = append(servicePlanLabelAfterInsertHooks, servicePlanLabelHook)
	case boil.AfterSelectHook:
		servicePlanLabelAfterSelectHooks = append(servicePlanLabelAfterSelectHooks, servicePlanLabelHook)
	case boil.AfterUpdateHook:
		servicePlanLabelAfterUpdateHooks = append(servicePlanLabelAfterUpdateHooks, servicePlanLabelHook)
	case boil.AfterDeleteHook:
		servicePlanLabelAfterDeleteHooks = append(servicePlanLabelAfterDeleteHooks, servicePlanLabelHook)
	case boil.AfterUpsertHook:
		servicePlanLabelAfterUpsertHooks = append(servicePlanLabelAfterUpsertHooks, servicePlanLabelHook)
	}
}
...
func (o *ServicePlanLabel) Resource(mods ...qm.QueryMod) servicePlanQuery {
...
func (o *ServicePlanLabel) SetResource(ctx context.Context, exec boil.ContextExecutor, insert bool, related *ServicePlan) error {
	var err error
	if insert {
...
func (o *ServicePlanLabel) RemoveResource(ctx context.Context, exec boil.ContextExecutor, related *ServicePlan) error {
	var err error
...
func FindServicePlanLabel(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*ServicePlanLabel, error) {
	...
	query := fmt.Sprintf(
		"select %s from `service_plan_labels` where `id`=?", sel,
	)
	...
	if err = servicePlanLabelObj.doAfterSelectHooks(ctx, exec); err != nil {
		return servicePlanLabelObj, err
	}
...
func (o *ServicePlanLabel) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO `service_plan_labels` () VALUES ()%s%s"
		}

		var queryOutput, queryReturning string

		if len(cache.retMapping) != 0 {
			cache.retQuery = fmt.Sprintf("SELECT `%s` FROM `service_plan_labels` WHERE %s", strings.Join(returnColumns, "`,`"), strmangle.WhereClause("`", "`", 0, servicePlanLabelPrimaryKeyColumns))
		}
	...
	o.ID = int(lastID)
	if lastID != 0 && len(cache.retMapping) == 1 && cache.retMapping[0] == servicePlanLabelMapping["id"] {
		goto CacheNoHooks
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for service_plan_labels")
	}
...
func (o *ServicePlanLabel) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
...
func (o ServicePlanLabelSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
	...
	sql := fmt.Sprintf("UPDATE `service_plan_labels` SET %s WHERE %s",
		...
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 0, servicePlanLabelPrimaryKeyColumns, len(o)))
...
var mySQLServicePlanLabelUniqueColumns = []string{
	"id",
	"guid",
}
...
func (o *ServicePlanLabel) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	nzDefaults := queries.NonZeroDefaultSet(servicePlanLabelColumnsWithDefault, o)
	nzUniques := queries.NonZeroDefaultSet(mySQLServicePlanLabelUniqueColumns, o)
	...
	if !cached {
		...
		cache.query = buildUpsertQueryMySQL(dialect, "`service_plan_labels`", update, insert)
		cache.retQuery = fmt.Sprintf(
			"SELECT %s FROM `service_plan_labels` WHERE %s",
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for service_plan_labels")
	}
	...
	uniqueMap, err = queries.BindMapping(servicePlanLabelType, servicePlanLabelMapping, nzUniques)
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for service_plan_labels")
	}
...
func (o *ServicePlanLabel) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
	...
	sql := "DELETE FROM `service_plan_labels` WHERE `id`=?"
...
func (o ServicePlanLabelSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}

	if len(servicePlanLabelBeforeDeleteHooks) != 0 {
		for _, obj := range o {
	...
	if len(servicePlanLabelAfterDeleteHooks) != 0 {
		for _, obj := range o {
...
func (o *ServicePlanLabel) Reload(ctx context.Context, exec boil.ContextExecutor) error {
...
func (o *ServicePlanLabelSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	if o == nil || len(*o) == 0 {
		return nil
	}
...
func ServicePlanLabelExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `service_plan_labels` where `id`=? limit 1)"
