...
var (
	dropletDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `DropletHash`: `varchar`, `ExecutionMetadata`: `text`, `State`: `varchar`, `ProcessTypes`: `text`, `ErrorID`: `varchar`, `ErrorDescription`: `text`, `EncryptedEnvironmentVariables`: `text`, `Salt`: `varchar`, `StagingMemoryInMB`: `int`, `StagingDiskInMB`: `int`, `BuildpackReceiptBuildpack`: `varchar`, `BuildpackReceiptBuildpackGUID`: `varchar`, `BuildpackReceiptDetectOutput`: `varchar`, `DockerReceiptImage`: `varchar`, `PackageGUID`: `varchar`, `AppGUID`: `varchar`, `Sha256Checksum`: `varchar`, `BuildGUID`: `varchar`, `DockerReceiptUsername`: `varchar`, `DockerReceiptPasswordSalt`: `varchar`, `EncryptedDockerReceiptPassword`: `varchar`, `EncryptionKeyLabel`: `varchar`, `EncryptionIterations`: `int`, `Sidecars`: `text`}
	_              = bytes.MinRead
)
...
func testDropletsUpsert(t *testing.T) {
	...
	if len(mySQLDropletUniqueColumns) == 0 {
