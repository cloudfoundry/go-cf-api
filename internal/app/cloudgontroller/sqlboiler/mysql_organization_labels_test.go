...
var (
	organizationLabelDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `ResourceGUID`: `varchar`, `KeyPrefix`: `varchar`, `KeyName`: `varchar`, `Value`: `varchar`}
	_                        = bytes.MinRead
)
...
func testOrganizationLabelsUpsert(t *testing.T) {
	...
	if len(mySQLOrganizationLabelUniqueColumns) == 0 {
