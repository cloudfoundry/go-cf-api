...
var (
	isolationSegmentAnnotationDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `ResourceGUID`: `varchar`, `KeyPrefix`: `varchar`, `Key`: `varchar`, `Value`: `varchar`}
	_                                 = bytes.MinRead
)
...
func testIsolationSegmentAnnotationsUpsert(t *testing.T) {
	...
	if len(mySQLIsolationSegmentAnnotationUniqueColumns) == 0 {
