...
var (
	buildDBTypes = map[string]string{`ID`: `integer`, `GUID`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `State`: `text`, `PackageGUID`: `text`, `ErrorDescription`: `text`, `AppGUID`: `text`, `ErrorID`: `text`, `CreatedByUserGUID`: `text`, `CreatedByUserName`: `text`, `CreatedByUserEmail`: `text`, `StagingMemoryInMB`: `integer`, `StagingDiskInMB`: `integer`}
	_            = bytes.MinRead
)
