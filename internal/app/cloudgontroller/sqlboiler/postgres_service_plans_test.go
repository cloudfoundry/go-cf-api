...
var (
	servicePlanDBTypes = map[string]string{`ID`: `integer`, `GUID`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `Name`: `USER-DEFINED`, `Description`: `text`, `Free`: `boolean`, `ServiceID`: `integer`, `Extra`: `text`, `UniqueID`: `text`, `Public`: `boolean`, `Active`: `boolean`, `Bindable`: `boolean`, `CreateInstanceSchema`: `text`, `UpdateInstanceSchema`: `text`, `CreateBindingSchema`: `text`, `PlanUpdateable`: `boolean`, `MaximumPollingDuration`: `integer`, `MaintenanceInfo`: `text`}
	_                  = bytes.MinRead
)
