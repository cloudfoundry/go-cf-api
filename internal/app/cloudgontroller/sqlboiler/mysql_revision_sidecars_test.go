...
var (
	revisionSidecarDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `Name`: `varchar`, `Command`: `varchar`, `RevisionGUID`: `varchar`, `Memory`: `int`}
	_                      = bytes.MinRead
)
...
func testRevisionSidecarsUpsert(t *testing.T) {
	...
	if len(mySQLRevisionSidecarUniqueColumns) == 0 {
