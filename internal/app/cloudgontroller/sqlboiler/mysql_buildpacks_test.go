...
var (
	buildpackDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `Name`: `varchar`, `Key`: `varchar`, `Position`: `int`, `Enabled`: `tinyint`, `Locked`: `tinyint`, `Filename`: `varchar`, `Sha256Checksum`: `varchar`, `Stack`: `varchar`}
	_                = bytes.MinRead
)
...
func testBuildpacksUpsert(t *testing.T) {
	...
	if len(mySQLBuildpackUniqueColumns) == 0 {
