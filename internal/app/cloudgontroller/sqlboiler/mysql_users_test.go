...
var (
	userDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `DefaultSpaceID`: `int`, `Admin`: `tinyint`, `Active`: `tinyint`, `IsOauthClient`: `tinyint`}
	_           = bytes.MinRead
)
