...
func (q serviceBrokerLabelQuery) Upsert(o *ServiceBrokerLabel, ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
