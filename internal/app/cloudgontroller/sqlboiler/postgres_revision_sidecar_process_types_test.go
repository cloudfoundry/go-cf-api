...
var (
	revisionSidecarProcessTypeDBTypes = map[string]string{`ID`: `integer`, `GUID`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `Type`: `character varying`, `RevisionSidecarGUID`: `character varying`}
	_                                 = bytes.MinRead
)
