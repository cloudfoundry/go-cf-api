...
var (
	eventDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `Timestamp`: `datetime`, `Type`: `varchar`, `Actor`: `varchar`, `ActorType`: `varchar`, `Actee`: `varchar`, `ActeeType`: `varchar`, `Metadata`: `text`, `OrganizationGUID`: `varchar`, `SpaceGUID`: `varchar`, `ActorName`: `varchar`, `ActeeName`: `varchar`, `ActorUsername`: `varchar`}
	_            = bytes.MinRead
)
