...
var (
	routeBindingLabelDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `ResourceGUID`: `varchar`, `KeyPrefix`: `varchar`, `KeyName`: `varchar`, `Value`: `varchar`}
	_                        = bytes.MinRead
)
...
func testRouteBindingLabelsUpsert(t *testing.T) {
	...
	if len(mySQLRouteBindingLabelUniqueColumns) == 0 {
