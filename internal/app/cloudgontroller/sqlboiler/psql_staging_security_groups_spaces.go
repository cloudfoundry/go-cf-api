// +build psql
//go:generate mockgen -source=$GOFILE -destination=mocks/staging_security_groups_spaces.go
...
func (o *StagingSecurityGroupsSpace) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
