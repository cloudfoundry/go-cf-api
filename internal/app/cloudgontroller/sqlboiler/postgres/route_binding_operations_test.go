...
var (
	routeBindingOperationDBTypes = map[string]string{`ID`: `integer`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `RouteBindingID`: `integer`, `State`: `character varying`, `Type`: `character varying`, `Description`: `character varying`, `BrokerProvidedOperation`: `character varying`}
	_                            = bytes.MinRead
)
