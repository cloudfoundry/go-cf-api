...
var (
	eventDBTypes = map[string]string{`ID`: `integer`, `GUID`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `Timestamp`: `timestamp without time zone`, `Type`: `text`, `Actor`: `text`, `ActorType`: `text`, `Actee`: `text`, `ActeeType`: `text`, `Metadata`: `text`, `OrganizationGUID`: `text`, `SpaceGUID`: `text`, `ActorName`: `text`, `ActeeName`: `text`, `ActorUsername`: `text`}
	_            = bytes.MinRead
)
