...
func testSpaceToManyAddOpServiceInstances(t *testing.T) {
	...
	for i, x := range foreignersSplitByInsertion {
		...
		if first.R.TargetSpaceSpaces[0] != &a {
			t.Error("relationship was not added properly to the slice")
		}
		if second.R.TargetSpaceSpaces[0] != &a {
			t.Error("relationship was not added properly to the slice")
		}
...
func testSpaceToManySetOpServiceInstances(t *testing.T) {
	var err error
	...
	//
	// if len(b.R.TargetSpaceSpaces) != 0 {
	// 	t.Error("relationship was not removed properly from the slice")
	// }
	// if len(c.R.TargetSpaceSpaces) != 0 {
	// 	t.Error("relationship was not removed properly from the slice")
	// }
	if d.R.TargetSpaceSpaces[0] != &a {
		t.Error("relationship was not added properly to the slice")
	}
	if e.R.TargetSpaceSpaces[0] != &a {
		t.Error("relationship was not added properly to the slice")
	}
...
func testSpaceToManyRemoveOpServiceInstances(t *testing.T) {
	var err error
