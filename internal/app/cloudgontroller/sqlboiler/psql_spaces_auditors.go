// +build psql
//go:generate mockgen -source=$GOFILE -destination=mocks/spaces_auditors.go
...
func (o *SpacesAuditor) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
