...
func testIsolationSegmentToManyOrganizations(t *testing.T) {
	...
	_, err = tx.Exec("insert into \"organizations_isolation_segments\" (\"isolation_segment_guid\", \"organization_guid\") values ($1, $2)", a.GUID, b.GUID)
	if err != nil {
		t.Fatal(err)
	}
	_, err = tx.Exec("insert into \"organizations_isolation_segments\" (\"isolation_segment_guid\", \"organization_guid\") values ($1, $2)", a.GUID, c.GUID)
	if err != nil {
		t.Fatal(err)
	}
