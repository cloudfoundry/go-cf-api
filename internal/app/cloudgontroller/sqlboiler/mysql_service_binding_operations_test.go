...
var (
	serviceBindingOperationDBTypes = map[string]string{`ID`: `int`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `ServiceBindingID`: `int`, `State`: `varchar`, `Type`: `varchar`, `Description`: `varchar`, `BrokerProvidedOperation`: `varchar`}
	_                              = bytes.MinRead
)
...
func testServiceBindingOperationsUpsert(t *testing.T) {
	...
	if len(mySQLServiceBindingOperationUniqueColumns) == 0 {
