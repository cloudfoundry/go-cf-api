...
func (q serviceBindingAnnotationQuery) Upsert(o *ServiceBindingAnnotation, ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
