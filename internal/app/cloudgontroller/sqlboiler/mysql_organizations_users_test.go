...
var (
	organizationsUserDBTypes = map[string]string{`OrganizationID`: `int`, `UserID`: `int`, `OrganizationsUsersPK`: `int`, `RoleGUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`}
	_                        = bytes.MinRead
)
...
func testOrganizationsUsersUpsert(t *testing.T) {
	...
	if len(mySQLOrganizationsUserUniqueColumns) == 0 {
