...
var (
	serviceBrokerDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `Name`: `varchar`, `BrokerURL`: `varchar`, `AuthPassword`: `varchar`, `Salt`: `varchar`, `AuthUsername`: `varchar`, `SpaceID`: `int`, `EncryptionKeyLabel`: `varchar`, `EncryptionIterations`: `int`, `State`: `varchar`}
	_                    = bytes.MinRead
)
...
func testServiceBrokersUpsert(t *testing.T) {
	...
	if len(mySQLServiceBrokerUniqueColumns) == 0 {
