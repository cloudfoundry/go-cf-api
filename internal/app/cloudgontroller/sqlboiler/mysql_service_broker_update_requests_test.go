...
var (
	serviceBrokerUpdateRequestDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `Name`: `varchar`, `BrokerURL`: `varchar`, `Authentication`: `varchar`, `Salt`: `varchar`, `EncryptionKeyLabel`: `varchar`, `EncryptionIterations`: `int`, `ServiceBrokerID`: `int`, `FKServiceBrokersID`: `int`}
	_                                 = bytes.MinRead
)
...
func testServiceBrokerUpdateRequestsUpsert(t *testing.T) {
	...
	if len(mySQLServiceBrokerUpdateRequestUniqueColumns) == 0 {
