// +build psql
//go:generate mockgen -source=$GOFILE -destination=mocks/app_annotations.go
...
func (o *AppAnnotation) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
