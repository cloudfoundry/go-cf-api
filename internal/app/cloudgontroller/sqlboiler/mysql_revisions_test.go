...
var (
	revisionDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `AppGUID`: `varchar`, `Version`: `int`, `DropletGUID`: `varchar`, `EncryptedEnvironmentVariables`: `text`, `Salt`: `varchar`, `EncryptionKeyLabel`: `varchar`, `EncryptionIterations`: `int`, `Description`: `text`}
	_               = bytes.MinRead
)
...
func testRevisionsUpsert(t *testing.T) {
	...
	if len(mySQLRevisionUniqueColumns) == 0 {
