...
var (
	serviceUsageEventDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `State`: `varchar`, `OrgGUID`: `varchar`, `SpaceGUID`: `varchar`, `SpaceName`: `varchar`, `ServiceInstanceGUID`: `varchar`, `ServiceInstanceName`: `varchar`, `ServiceInstanceType`: `varchar`, `ServicePlanGUID`: `varchar`, `ServicePlanName`: `varchar`, `ServiceGUID`: `varchar`, `ServiceLabel`: `varchar`, `ServiceBrokerName`: `varchar`, `ServiceBrokerGUID`: `varchar`}
	_                        = bytes.MinRead
)
...
func testServiceUsageEventsUpsert(t *testing.T) {
	...
	if len(mySQLServiceUsageEventUniqueColumns) == 0 {
