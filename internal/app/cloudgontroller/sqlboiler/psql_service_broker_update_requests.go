// +build psql
//go:generate mockgen -source=$GOFILE -destination=mocks/service_broker_update_requests.go
...
func (o *ServiceBrokerUpdateRequest) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
