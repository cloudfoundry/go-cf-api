...
var (
	servicePlanLabelDBTypes = map[string]string{`ID`: `int`, `GUID`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `ResourceGUID`: `varchar`, `KeyPrefix`: `varchar`, `KeyName`: `varchar`, `Value`: `varchar`}
	_                       = bytes.MinRead
)
...
func testServicePlanLabelsUpsert(t *testing.T) {
	...
	if len(mySQLServicePlanLabelUniqueColumns) == 0 {
