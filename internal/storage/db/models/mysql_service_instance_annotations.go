...
func (q serviceInstanceAnnotationQuery) Upsert(o *ServiceInstanceAnnotation, ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
