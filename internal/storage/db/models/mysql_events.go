...
func (q eventQuery) Upsert(o *Event, ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
...
var (
	...
	eventColumnsWithoutDefault = []string{"guid", "updated_at", "timestamp", "type", "actor", "actor_type", "actee", "actee_type", "metadata", "organization_guid", "space_guid", "actor_name", "actee_name", "actor_username"}
