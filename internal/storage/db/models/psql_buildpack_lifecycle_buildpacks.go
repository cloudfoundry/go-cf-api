...
//go:generate sh -c "echo '\x2bbuild unit' > ../../../../buildtags.txt && mockgen -source=$GOFILE -destination=mocks/buildpack_lifecycle_buildpacks.go -copyright_file=../../../../buildtags.txt && rm -f ../../../../buildtags.txt"
