...
func (q buildpackAnnotationQuery) Upsert(o *BuildpackAnnotation, ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
