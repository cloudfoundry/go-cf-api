...
func (q serviceOfferingAnnotationQuery) Upsert(o *ServiceOfferingAnnotation, ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
