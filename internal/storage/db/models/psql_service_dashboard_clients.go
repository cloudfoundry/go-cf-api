...
//go:generate sh -c "echo '\x2bbuild unit' > ../../../../buildtags.txt && mockgen -source=$GOFILE -destination=mocks/service_dashboard_clients.go -copyright_file=../../../../buildtags.txt && rm -f ../../../../buildtags.txt"
